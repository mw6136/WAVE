...
def get_anal_data_specific_time(time):

    if round(time,2) != time:
        raise("Time has to be rounded to the hundredth of a second")

    if time > 6.5 or time < 0:
        raise("Need 0 ≤ time ≤ 6.5")
