...
Z_DNS_div, times_div = discrete_run(1.6e-4, 0.05, record_all=True)
Z_DNS_CFL, times_CFL = discrete_run(1.5e-4, 0.05, record_all=True)
...
print(
    "Successfully ran all of discrete.py in "
